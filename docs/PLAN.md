...
| 项 | 内容 |
|---|---|
| 状态 | 已在 `159654f` 运行一次（46 house，4 worker，21 分钟）：成功 23、失败 23，非空成品率 0.378，**门未过**（LOG-236）；规模裁决 25～29 待定，重生成未授权 |

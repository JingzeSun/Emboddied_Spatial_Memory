...
**2026-09-24 裁决 70 (a) 落地（LOG-255 续，`f4f694a`）**：S0-04 新增次级节点列 `node_prf1_centroid`（同集合、同匹配器、质心距离 ≤ δ_moved 0.5 m、权重 1／(1＋距离)），S2-04 headline 与 S2-05 开发表并列报告；主列 IoU 0.3、裁决 C／V 不变；S0-04／S2-04／S2-05 摘要重钉。校准趟不重跑；后续趟在新提交上运行。**下一步**：等校准趟跑完提裁决 68。

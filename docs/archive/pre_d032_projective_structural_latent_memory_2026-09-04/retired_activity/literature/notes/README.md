...
- [后验图修订相关工作与结构化审计](posterior_revision_landscape_2026.md)：当前 ESGBU 主线、SA1–SA8、成熟重合工作、loss 与数据轨
- [跨论文综合与研究建议](00_cross_paper_synthesis.md)
- [结构区域到持久世界节点](structural_region_world_binding_2026.md)：透视/平面/slot/2D→3D 融合先例、不能重复主张的内容与 HC-014 消融边界
- [时序图模型与多任务 loss 设计](temporal_graph_and_loss_design_2026.md)：TGN/结构化 world belief 强基线，以及 GradNorm、uncertainty weighting、PCGrad 只在诊断后使用的边界

...
learned posterior 的第一训练集由 symbolic generator 生成；每条 transaction 必须保存 `observed_at`、`received_at`、source/evidence group、generator seed/version、counterfactual group 和 factor values。AI2-THOR、3RScan/3DSSG、Dyn-THOR 分别建 manifest，不与 symbolic test 混成总平均。

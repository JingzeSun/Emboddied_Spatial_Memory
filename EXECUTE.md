...
## LOG-074?2026-09-09????????? train ????????????????

- ??????????????????????????????? 280 ???????? 1000-group train ????? main ???????????????????????????????????? hash ????? 16 ??????????????? D-051???????????? train/inner-dev ?????
- ?????? `src/cpmt/m1_branch_preflight.py` ? `scripts/run_m1_train_branch_preflight.py`???????? 16?2?7=224 ????4480 ???????? materializer?scope ? executor ????????????????????????????????????????????????????????? worker ????? paired group ???????????? spawn ? CPU/BLAS ????????????????
- runner ???????? corrected train marker????????1000-group/32-bin/train ???????manifest???????? 16 ?????? hash?????????????????????????????? helper???????????????????? 16 ????????????????? digest ??????????????? 1000 ?????????????????
- ???? base/post hash?????scope?C11 ????????MERGE ??? executor ??????????????/event/????????????????? frame ??/event ???? traceback??????????????????????????/???????20 ??????? PASS?
- 11 ????????0.004 ???????????? mock ??????????????????????????scope ?????K ?????? train ??????????/??????????????C11 ??????????????Python AST ? CLI help ???????????????????causal rollout ?????????????????????????
- ???????????????? main ? train ??????????????? ops ????????????fit/inner-dev ????????? probe/????????????????????????

...
| 事项 | 已知事实 |
|---|---|
| VM-04目标边界与动作探针 | D-165旧16个完整episode首目标均非作者物体，新v2扫描top-2的72项中70项非作者物体；固定pose另有36/36槽至少2件可见作者资产与2件可移动资产。D-166四项目标语义已获批准，D-167新目标探针代码已交审且本地纯测试43项、服务器三worker纯check 43项通过，D-168仅v3新目标探针闸门true，生成/训练仍false；原D-164墙面目标探针继续先验拒绝。根因/资格/重复报告SHA-256见LOG-155–156，新探针代码范围见LOG-157；旧单进程JSON审计和65位计划摘要笔误在D-166如实登记；无新服务器物理干预或episode。 |

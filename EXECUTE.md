...
**2026-09-24 最新暂停点：S0 口径按裁决 56 续、57、58 修订完毕（LOG-244 续二），S1 不重做；下一步是 S2（五臂开发表），开工前需用户审本次合同与代码改动。** 真值范围排除 wall／room／door／window；实体框改为同帧并集；召回四值 k=5／k′=3／3 m／出生半径 1.0 m 全部冻结。

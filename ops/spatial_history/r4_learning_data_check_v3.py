"""Retry the sealed R4 reader check with the public-family query bridge."""
...
check.CONFIG = ROOT / "configs/spatial_history/r4_learning_data_check_v3.json"
check.RUN = Path("/root/autodl-tmp/spatial-history/sh05-r4-learning-data-check-v3")
check.REPORT = ROOT / "results/spatial_history_r4_learning_data_v3.json"
check.STAGE = "SH-05-R4-learning-data-check-v3"
check.CONFIG_VERSION = "sh05-r4-learning-data-check-v3"
check.BOUND = tuple(name for name in check.BOUND
                    if name != "configs/spatial_history/r4_learning_data_check_v1.json") + (
    "configs/spatial_history/r4_learning_data_check_v3.json",
    "src/spatial_world_model/r4_public_v2.py",
    "ops/spatial_history/r4_learning_data_check_v3.py",
)

...
???????????????????????????????????????? v7/v9 train ??? D-051 ????? 16 ??????????? 224 ? 20-step ???????????????????? MERGE ??????????????????? CTL ????????????? 20 ?????????

??? `run_m1_train_branch_preflight.py`?????? `m1_branch_preflight.fixed_plan()` ????????????? D-051??????????? SHA-256???????????????????????????????????????? 16 ? audit ?????????????????`complete_branch_matrix` ???????sibling????????????`preferred_template_unavailable` ?????????????????? NOOP ????`minimum_c11_unrelated_candidates` ????? C11 ??????????????????????????? probe/?????????????????????

?????????? index/template/static_preflight_pass?legal/post_graph?reference?future ????????????? executor-illegal ???????????????K=16 ??? invariant ?????? base/event/?????????????????????????????????????????????????? PASS?

??????????????????????????????????????? ops ???? train ????????????/???????????? validation/test?????????????? margin?N ????????

"""R4 v2 MuJoCo adapter: independent gates and directly streamed lossless shards.
...
from .r4_families_v2 import xml_template_view, validate_family_config
...
def build_xml(reference, config, world_name):
    ...
    tree = ET.fromstring(base_xml(reference, xml_template_view(config), world_name))
    tree.set("model", "sh04-r4-continuous-family-v2")
    g = config["geometry"]
